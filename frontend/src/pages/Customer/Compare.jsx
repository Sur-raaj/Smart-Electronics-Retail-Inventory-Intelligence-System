              ...
              <tbody>
                <tr>
                  ...
                  {[...Array(3 - items.length)].map((_, i) => (
                    <td key={`empty-`} style={{ ...styles.td, background: "#e07b3c" }}>
                ...
                <tr>
                  ...
                  {[...Array(3 - items.length)].map((_, i) => <td key={`empty-price-`} style={{ ...styles.td, background: "#f8fafc" }}></td>)}
                </tr>
                <tr>
                  ...
                  {[...Array(3 - items.length)].map((_, i) => <td key={`empty-cat-`} style={{ ...styles.td, background: "#f8fafc" }}></td>)}
                </tr>
                ...
                {showSpecs && (
                  <>
                    <tr>
                      <th style={{ ...styles.th, paddingLeft: 32, fontSize: 13 }}>Performance</th>
                      {items.map((item) => (
                        <td key={item.id} style={styles.td}><span style={styles.value}>{getSpecs(item).performance}</span></td>
                      ))}
                      {[...Array(3 - items.length)].map((_, i) => <td key={`empty-perf-${i}`} style={{ ...styles.td, background: "#f8fafc" }}></td>)}
                    </tr>
                    <tr>
                      <th style={{ ...styles.th, paddingLeft: 32, fontSize: 13 }}>Memory & Storage</th>
                      {items.map((item) => (
                        <td key={item.id} style={styles.td}><span style={styles.value}>{getSpecs(item).memory}</span></td>
                      ))}
                      {[...Array(3 - items.length)].map((_, i) => <td key={`empty-mem-${i}`} style={{ ...styles.td, background: "#f8fafc" }}></td>)}
                    </tr>
                    <tr>
                      <th style={{ ...styles.th, paddingLeft: 32, fontSize: 13 }}>Display</th>
                      {items.map((item) => (
                        <td key={item.id} style={styles.td}><span style={styles.value}>{getSpecs(item).display}</span></td>
                      ))}
                      {[...Array(3 - items.length)].map((_, i) => <td key={`empty-disp-${i}`} style={{ ...styles.td, background: "#f8fafc" }}></td>)}
                    </tr>
                  </>
                )}
                <tr>
                  ...
                  {[...Array(3 - items.length)].map((_, i) => <td key={`empty-rating-`} style={{ ...styles.td, background: "#f8fafc" }}></td>)}
                </tr>
                <tr>
                  ...
                  {[...Array(3 - items.length)].map((_, i) => <td key={`empty-stock-`} style={{ ...styles.td, background: "#f8fafc" }}></td>)}
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  {[...Array(3 - items.length)].map((_, i) => <td key={`empty-action-`} style={{ ...styles.td, background: "#f8fafc" }}></td>)}
                </tr>
              </tbody>
            </table>
          </div>
